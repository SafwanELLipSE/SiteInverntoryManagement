      ...
      <div class="sparkline10-list mg-tb-30 responsive-mg-t-0 table-mg-t-pro-n dk-res-t-pro-0 nk-ds-n-pro-t-0">
        <div class="sparkline10-hd" style="margin-bottom: 2rem;">
           <div class="main-sparkline10-hd">
               <h1>
                 <span style="border-bottom: 2px solid #333333;">Edit Category: </span>
               </h1>
           </div>
       </div>
               ...
               <div class="row">
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="form-group">
                         ...
                         <input name="category" type="text" value="{{ $category->name }}" class="form-control" placeholder="Edit Category">
                     </div>
                     <div class="row">
                         <div class="col-lg-12">
