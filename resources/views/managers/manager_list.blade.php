                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                ...
                                <li>
                                  <span class="bread-blod">All Managers List</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                              ...
                              <tbody>
                                @foreach($managers as $item)
                                  <tr>
                                    ...
                                    <td>{!! App\Site_manager::getGender($item->gender) !!}</td>
                                    ...
                                    <td>
                                      <form  action="{{ route('manager.delete') }}" method="post">
                                        ...
                                        <a href="{{ route('manager.details',$item->id) }}" class="btn btn-primary btn-xs" style="color:#FFFFFF !important; margin-right: .2rem"><i class="fa fa-info-circle edu-informatio"></i> view</a><button type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash edu-informatio"></i> Delete</button>
                                      </form>
                                      </td>
                                  </tr>
                                @endforeach
